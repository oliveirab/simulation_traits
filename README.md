The following R code simulates assemblages, calculates functional diversity metrics (FD) and correlates FD values with species richness, range and standard deviation in trait values.
